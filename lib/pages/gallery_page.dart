...
import 'package:temp/widgets/pokemon_card_gallery.dart';
  ...
  Future<void> _loadMoreData() async {
    ...
    if (nextUrl != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('¡Has llegado al final de tu Galería!')),
      );
    }
  }
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Padding(
                          ...
                          child: GestureDetector(
                            onTap: () async {
                              PokemonGallery? pokemonGallery = await PokemonDB.getPokemonGalleryById(pokemonDetail.id);

                              if (pokemonGallery != null) {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => PokemonGalleryDetailPage(pokemonGallery: pokemonGallery),
                                  ),
                                );
                              } else {
                                final snackBarText = 'No se ha encontrado Galería de este Pokemon';
                                final snackBar = SnackBar(
                                  content: Text(snackBarText),
                                );
                                ScaffoldMessenger.of(context).showSnackBar(snackBar);                              }
                            },
                            child: PokemonCardGallery(index: index, pokemon: pokemonDetail),
                          ),
                        );
                      },
                    )

...
class PokemonCardEvolution extends StatelessWidget {
  final int index;
  final PokemonDetail pokemon;
  const PokemonCardEvolution({super.key, required this.index, required this.pokemon});

  @override
  Widget build(BuildContext context) {
    return UnconstrainedBox(
      child: Container(
        width: ScreenUtil.screenWidth(context) * 0.90,
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              top: ScreenUtil.diagonal(context) * 0.015,
